...
const Home = () => {
  ...
  <div className="order-1 md:order-2 w-full h-1/2 md:w-2/5 md:h-full relative flex justify-center items-center bg-neutral-950 dark:bg-neutral-200">
    <div className="w-3/4 h-3/4 bg-cover bg-center rounded-md z-10" style={{ backgroundImage: 'url(placeholder.jpg)' }}>
      ...
      <section className="h-auto md:h-2/3  m-6 md:m-10 flex flex-col md:flex-row items-center justify-between p-5 mb-16 bg-neutral-950 text-neutral-200 dark:bg-neutral-200 dark:text-neutral-800">
        ...
        <div className="w-full md:w-2/5 mt-6 md:mt-0">
          <img src="" alt="" className="w-full bg-neutral-200 dark:bg-neutral-800  h-48 md:h-96 object-cover rounded-md" />
        </div>
      </section>
    </div>
  );
