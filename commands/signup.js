...
const generateSignup = (dir) => {
  const filePath = path.join(dir,'SignIn.jsx');
  fs.ensureDirSync(path.dirname(filePath));
  fs.writeFileSync(filePath, signupCode, 'utf8');
  console.log('Signup.jsx file has been generated in the current directory.');
};

module.exports = { generateSignup };
