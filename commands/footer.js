...
const generateFooter = (dir) => {
  const filePath = path.join(dir,'Footer.jsx');
  fs.ensureDirSync(path.dirname(filePath));
  fs.writeFileSync(filePath, footerCode, 'utf8');
  console.log('Footer.jsx file has been generated in the currents directory.');
};
