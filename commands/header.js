...
const generateHeader = (dir) => {
  const filePath = path.join(dir, 'Header.jsx');
  fs.ensureDirSync(path.dirname(filePath));
  fs.writeFileSync(filePath, headerCode, 'utf8');
  console.log('Header.jsx file has been generated in the current directory.');
};
